local keys = {
	...
	{ "<leader>g", group = "Git" },
	{ "<leader>gb", ":FzfLua git_branches winopts.preview.border=noborder<cr>", desc = "branches" },
	{ "<leader>gf", ":FzfLua git_bcommits winopts.preview.border=noborder<cr>", desc = "file commits" },
	{ "<leader>gg", ":Gitsigns blame_line<cr>", desc = "show git blame" },
	{ "<leader>gp", ":Gitsigns preview_hunk_inline<cr>", desc = "show changes" },
	{ "<leader>gs", ":FzfLua git_status winopts.preview.border=noborder<cr>", desc = "status" },
	{ "<leader>l", group = "Lsp" },
